    ...
    <script type="text/javascript">
        ...
        function sureToDelete(id){
            if(confirm("Are you sure you want to Delete this request?")){
                window.location.href ='delete-client.php?id='+id;
            }
        }
    </script>
    ...
    <div class="container p-sm-3">
        <div class="row justify-content-center">
            <div class="col-sm-12">
                ...
                <a href="admin-add-user.php" class="btn btn-info btn-sm mb-3 p-sm-2">Add Buyers</a>
                ...
                <table id="example" class="table table-striped ">
                    ...
                    <?php foreach ($rows as $buyers): ?>
                        ...
                        <tr>
                            ...
                            <td> <?= $buyers["email"] ?> </td>
                            <td> <?= $buyers["phone"] ?> </td>
                            <td><a class="btn btn-info btn-sm" href="javascript:sureToEdit(<?php echo $buyers['id'];?>)" >Update</a></td>
                            <td><a class="btn btn-danger btn-sm" href="javascript:sureToDelete(<?php echo $buyers['id'];?>)">Delete</a></td>
                        </tr>
